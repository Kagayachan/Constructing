...
public static class DiagnosticCodes
{
    ...
    public const string SsfResourceLimitExceeded = "SSF_RESOURCE_LIMIT_EXCEEDED";
    ...
    public const string MaskInvalid = "MASK_INVALID";
    ...
    public const string InstallLocked = "INSTALL_LOCKED";
}
