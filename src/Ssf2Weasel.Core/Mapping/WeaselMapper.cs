...
public static class WeaselMapper
{
        ...
        IFontChecker fontChecker)
    {
        ...
        AddFontIfUsable(skin.Typography.ChineseFont, "Display/font_ch", fontChecker, fontFaces, diagnostics);
        ...
        var primaryCjkFont = fontFaces[0];
        ...
        var theme = new WeaselTheme
        {
            ...
            FontFace = fontFace,
            LabelFontFace = primaryCjkFont,
            CommentFontFace = primaryCjkFont,
            FontPoint = fontPoint,
    ...
    private static void AddFontIfUsable(
        string? font,
        string sourceKey,
        IFontChecker fontChecker,
        List<string> target,
        ...
        int fallback)
    {
        ...
        if (layoutValues.Count < 3)
        {
            return fallback;
        }

        var a = layoutValues[1];
        var b = layoutValues[2];
        var average = (a + b) / 2;
